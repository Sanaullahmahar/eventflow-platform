...
import { footerColumns } from "@/shared/config/siteContent";

const Footer = () => {
  const [email, setEmail] = useState("");

  return (
    <footer className="bg-primary-deep pb-8 pt-16">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <button
                className="rounded-lg bg-accent-cyan p-2 text-foreground transition-transform hover:scale-105"
